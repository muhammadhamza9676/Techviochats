    ...
    <section id="pricing" className="wow fadeInUp section-bg">
      <div className="container">
        <header className="section-header">
          <h3>Pricing</h3>
          <p>We believe in our clients and our strength lies in developing close working relationships to help them succeed</p>
        </header>
        ...
        <div className="row flex-items-xs-middle flex-items-xs-center">
          ...
          <div className="col-xs-12 col-lg-4">
            <div className="card">
              <div className="card-header">
                <p>Starting from</p>
                <h3><span className="currency">$</span>100<span className="period"></span></h3>
              </div>
              <div className="card-block">
                ...
                <a href="https://api.whatsapp.com/send/?phone=%2B923453191638&amp;text&amp;app_absent=0" className="btn">Contact Us</a>
              </div>
            </div>
          </div>
          ...
          <div className="col-xs-12 col-lg-4">
            <div className="card">
              <div className="card-header">
                <p>Starting from</p>
                <h3><span className="currency">$</span>250<span className="period"></span></h3>
              </div>
              <div className="card-block">
                <h4 className="card-title">
                  Whatsapp AI Chatbot
          ...
          <div className="col-xs-12 col-lg-4">
            <div className="card">
              <div className="card-header">
                <p>Starting from</p>
                <h3><span className="currency">$</span>350<span className="period"></span></h3>
              </div>
              <div className="card-block">
                <h4 className="card-title">
                  Outbound Call Assistant
                </h4>
                <ul className="list-group">
